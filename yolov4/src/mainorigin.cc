...
Darknet net("/home/hzh/Desktop/catk/src/yolov4/models/yolov4.cfg", &device);
int input_image_size;
ros::Publisher pub;
using namespace std;
void image_callback(const sensor_msgs::ImageConstPtr& msg){
  
    std_msgs::Float64MultiArray point_arr;
...
int main(int argc, char* argv[])
{
  ...
  // std::string cfg_file = "/home/hzh/Desktop/catk/src/yolov4/models/yolov4.cfg";
  ...
  net.load_darknet_weights("/home/hzh/Desktop/catk/src/yolov4/models/yolov4.weights");
